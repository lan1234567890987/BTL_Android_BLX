...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LL_thi.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent(MainActivity.this, QuyCheAct.class);
        ...
        LL_on.setOnClickListener(new View.OnClickListener()
        {
            ...
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, OnThiAct.class);
                startActivity(intent);
            }
        ...
        LL_bien.setOnClickListener(new View.OnClickListener()
        {
            ...
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, TraBienAct.class);
                startActivity(intent);
            }
        ...
        LL_luat.setOnClickListener(new View.OnClickListener()
        {
            ...
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, TraLuatAct.class);
                startActivity(intent);
            }
